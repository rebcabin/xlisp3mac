...
#ifdef xlSEGADDR
#define xlINSEGMENT(n,s)    ((unsigned long)(n) >> 16 == (unsigned long)(s) >> 16)
#define xlVCOMPARE(f,s,t)   ((s) <= (xlFIXTYPE)(unsigned int)((t) - (f)))
#define xlVSFREE(f,t)       ((t) - (f))
#endif
...
#define xlGetClass(x)           xlGetEnvElement(x,0)
#define xlSetClass(x,v)         xlSetEnvElement(x,0,v)
#define xlGetIVar(x,i)          xlGetEnvElement(x,i)
#define xlSetIVar(x,i,v)        xlSetEnvElement(x,i,v)
